...
def main():
    ...
    file_path = "/home/farid/ros-rl-env/catkin_ws/src/rl_interact/rl_model/best_model_camera.zip"
...
# def test(env_config, ros_config, rl_config, run_name):
#     log_dir = "/home/farid/cranfield-navigation-gym/log_dir"
#     env = DummyVecEnv([lambda: make_vec_env("DroneNavigationGDP-v0", env_config, ros_config, log_dir)])

#     file_path = "/home/farid/cranfield-navigation-gym/log_dir/DroneNavigationGDP-v0_TD3_20250309_141034_gdp-test/model/best_model.zip"
