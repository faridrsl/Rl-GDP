...
class DroneNavigationSimple(gym.Env):
    ...
    **Features:**
    ...
    def step(self, action):
        ...
        # print(terminated, self.current_step, action)
    ...
    def _perform_action(self, action):
        ...
        if DISCRETE_ACTIONS:
            ...
            self.ros.set_drone_velocity(*action)
    ...
    def _get_state(self, obs_space_type, goal_reached_threshold, action):
        ...
        lidar_state_normalized = self._normalize_lidar(lidar_state, max_range=16.0)
    ...
    def _respawn_robot(self):
        ...
        """
        self.ros.respawn_robot(top_height=1.0)

    def _reset_goal(self, goal_z_max=0):
        """
